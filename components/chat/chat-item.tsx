...
const ChatItem = ({
    id, content, member, timestamp, fileUrl,
    deleted, currentMember, isUpdate, socketUrl, socketQuery} : ChatItemProps) => {
    ...
    const canDeleteMessage = (isAdmin || isModerator || isOwner) && !deleted;
    ...
    return (
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-fullw">
                    ...
                    {isPDF && (
                        <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
                            ...
                            <a href={content} target="_blank" rel="noopener noreferrer" className="ml-2 text-sm text-indigo-500
                                    ...
                                    <FormItem className="flex-1">
                                        <FormControl>
                                            <div className="relative w-full">
                                                <Input
                                                    disabled={isLoading}
                                                    className="px-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-none
